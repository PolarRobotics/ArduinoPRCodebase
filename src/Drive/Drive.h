...
#define BIG_BOOST_PCT 0.5  // default: 0.5, this is the typical percentage of power out of the motors' range that is used (to ensure they don't do seven wheelies)
#define BIG_NORMAL_PCT 0.3 
#define BIG_SLOW_PCT 0.2   // should be a value less than BIG_NORMAL_PCT, to slow down for precision maneuvering
#define BRAKE_BUTTON_PCT 0 // the value for brake button to slow down the motors at the button press
